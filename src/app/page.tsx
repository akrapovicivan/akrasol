...
export default function HomePage() {
    return (
        <div>
            <div className="w-full h-[582px] bg-cover bg-center px-48" 
                style={{ backgroundImage: 'linear-gradient(0deg, rgba(0, 0, 0, 0.8) 0%, rgba(0, 0, 0, 0) 100%), url(/images/panels-hero.png)' }}>
                <div className="min-[888px]:ml-20 min-[888px]:w-[461px] h-full bg-[#212121]/40 text-white flex flex-col justify-end p-10" >
            ...
            <div className="p-8 px-48 flex flex-row justify-center gap-x-20">
