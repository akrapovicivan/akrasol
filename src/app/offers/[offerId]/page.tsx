        ...
        <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
            <div className="w-full grid rounded-lg bg-blue-50 p-4 dark:bg-blue-800 md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16 gap-8">
                <div className="lg:col-span-5 lg:mt-0">
                    <img className="object-cover mb-4 h-auto w-full sm:h-auto sm:w-full md:h-full md:w-full rounded-xl max-w-[512px] md:flex-grow" src={"/images/offers/" + params.offerId + ".webp"} alt="peripherals" />
                </div>
